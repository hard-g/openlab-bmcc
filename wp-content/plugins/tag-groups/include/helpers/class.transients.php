...
if ( ! class_exists( 'TagGroups_Transients' ) ) {
  ...
  class TagGroups_Transients {
    ...
    public static function purge_all_transients() {
      ...
      $count += TagGroups_Transients::delete_all_transients();
    ...
    static function get_used_names() {
      ...
      if ( TagGroups_Transients::TRANSIENT_NAMES ) {

        return get_option( TagGroups_Transients::TRANSIENT_NAMES, array() );
    ...
    static function set_used_names( $used_transient_names ) {
      ...
      if ( TagGroups_Transients::TRANSIENT_NAMES ) {
        ...
        update_option( TagGroups_Transients::TRANSIENT_NAMES, $used_transient_names, true );
    ...
    static function delete_transient( $transient ) {
      ...
      if ( delete_transient( $transient ) ) {
        ...
        $used_transient_names = TagGroups_Transients::get_used_names();

        unset( $used_transient_names[$transient] );

        TagGroups_Transients::set_used_names( $used_transient_names );
    ...
    static function delete_all_transients( $substring = '' ) {
      ...
      foreach ( $used_transient_names as $transient ) {
