...
if ( !class_exists( 'TagGroups_Hooks' ) ) {
    ...
    class TagGroups_Hooks
    {
        ...
        public function root_all()
        {
             ...
             * @param string Logical relation between the Tag Group IDs (AND|OR)
        ...
        public function is_admin()
        {
             ...
             */
            add_filter( 'block_categories', array( 'TagGroups_Gutenberg', 'block_categories' ) );
            /**
             ...
             */
            add_action( 'groups_of_term_saved', array( $tag_group_groups, 'schedule_clear_tag_groups_group_terms' ), 11 );
            /**
             * After a term has been deleted, we might have to update the object cache
             */
            add_action( 'delete_term', array( $tag_group_groups, 'schedule_clear_tag_groups_group_terms' ), 20 );
            /**
             ...
             */
            add_action( 'wp_ajax_tg_render_shortcode', array( 'TagGroups_Shortcode', 'render' ) );
        }
        ...
        public function not_is_admin()
        {
            ...
            add_action( 'init', array( 'TagGroups_Shortcode', 'maybe_do_shortcode_in_widgets' ) );
        }
        ...
        private function user_can_tag_group_role_edit_tags( $enabled_taxonomies )
        {
             ...
             */
            add_action( 'create_term', array( 'TagGroups_Admin', 'maybe_copy_term_group_to_translation' ), 20 );
            /**
             * Saves the tag group; other tag info saved anyway
             */
            add_action( 'create_term', array( 'TagGroups_Admin', 'save_term_group_without_tag_info' ) );
            /**
             * Saves the tag group; need to save also other tag info
             */
            add_action( 'edit_term', array( 'TagGroups_Admin', 'save_term_group_with_tag_info' ) );
        }
