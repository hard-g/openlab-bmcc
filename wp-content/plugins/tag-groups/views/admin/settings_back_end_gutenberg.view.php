<div class="tg_settings_tabs_content">
  ...
  <form method="POST" action="<?php echo esc_url($_SERVER['REQUEST_URI']) ?>">
    ...
    <p>
      ...
      <span class="dashicons dashicons-editor-help chatty-mango-help-icon" data-topic="gutenberg-render"></span>
    </p>
    <div class="chatty-mango-help-container chatty-mango-help-container-gutenberg-render" style="display:none;">
      <?php _e('Some blocks can show an approximate preview in the Gutenberg editor. If you deactivate this option, then all blocks will show a static icon with text.', 'tag-groups') ?>
    </div>
    <p>&nbsp;</p>
