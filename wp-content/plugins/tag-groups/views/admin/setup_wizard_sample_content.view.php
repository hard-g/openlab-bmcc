<div style="margin: 50px 0 0;">
  ...
  <form method="post" action="<?php echo $setup_wizard_next_link ?>">
    ...
    <p>
      <input type="checkbox" autocomplete="off" value=1 id="tag-groups-create-sample-page" name="tag-groups-create-sample-page" >&nbsp;<label for="tag-groups-create-sample-page"><?php echo $create_sample_page_label ?></label>
    </p>
