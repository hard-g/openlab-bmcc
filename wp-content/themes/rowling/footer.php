		...
		<footer class="credits">
			...
			<div class="section-inner">
				...
				<!-- hack to remove copyright and year. Should be repaced with actual solution. Original commented out (IN HTML above) -->
				<p class="copyright"> <a href="<?php echo esc_url( home_url( '/' ) ); ?>" rel="home"><?php echo wp_kses_post( get_bloginfo( 'title' ) ); ?></a></p>
